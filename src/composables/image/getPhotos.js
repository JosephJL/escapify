...
const images = [
  "https://firebasestorage.googleapis.com/v0/b/foodapp-2ef25.appspot.com/o/placeholder1.jpg?alt=media&token=015e9f13-1c32-41d8-8f7c-507e2fce563d",
  "https://firebasestorage.googleapis.com/v0/b/foodapp-2ef25.appspot.com/o/placeholder2.jpg?alt=media&token=87d6fb5c-d4bf-4d2f-91a9-654450a080a1",
  "https://firebasestorage.googleapis.com/v0/b/foodapp-2ef25.appspot.com/o/placeholder3.jpg?alt=media&token=0f649ae0-e618-44a1-985e-f7e901f3e779",
  "https://firebasestorage.googleapis.com/v0/b/foodapp-2ef25.appspot.com/o/placeholder4.jpg?alt=media&token=41eece76-c482-43ce-9e0a-c882f8fd5219",
];
...
const getPlacePhoto = () => {
  ...
  const load = async (placeName) => {
    ...
    await axios(config)
      ...
      .catch((err) => (imageLoading.value = true)); // Included this because the api isnt activated
